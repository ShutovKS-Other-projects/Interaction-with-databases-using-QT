...
{
    ui->lineEdit_path->setText(QFileDialog::getOpenFileName(0,"Выберете файл",".\\","*.html"));
}


void PrintDialog::on_pushButton_form_clicked()
{
    ...
    doc->dynamicCall("Open(QVariant)", ui->lineEdit_path->text());
}
